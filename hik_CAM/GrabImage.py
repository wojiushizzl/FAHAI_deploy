...
# sys.path.append("/home/tef9/Documents/haikang/Python/MvImport")
...
def work_thread(cam=0, pData=0, nDataSize=0):
	...
	while True:
		...
		if ret == 0:
		   ...
		   % (stOutFrame.stFrameInfo.nWidth, stOutFrame.stFrameInfo.nHeight, stOutFrame.stFrameInfo.enPixelType, stOutFrame.stFrameInfo.nFrameNum,stOutFrame.stFrameInfo.nFrameLen))
